...
function Page() {
  return (
    <div className="py-32 px-12 flex flex-col gap-12">
      ...
      <div className="px-16 flex flex-col gap-4 tracking-wide text-gray-900 text-xs">
        <p>
          Hindalco Industries Limited is the metals flagship company of the
          Aditya Birla Group. A US$28 billion metals powerhouse, Hindalco is an
        ...
        <p>
          ...
          aluminium is accepted for delivery under the High-Grade Aluminium
          Contract on the London Metal Exchange (LME), while its copper quality
          is also registered on the LME with Grade A accreditation.
        </p>
      </div>
    </div>
  );
